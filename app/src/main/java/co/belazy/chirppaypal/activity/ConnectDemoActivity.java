...
public class ConnectDemoActivity extends AppCompatActivity {
    ...
    ConnectEventListener connectEventListener = new ConnectEventListener() {
        ...
        public void onReceived(byte[] data, byte channel) {
            ...
            if (hexData.contains("EC-")){
                startActivity(new Intent(ConnectDemoActivity.this,PayPalWebViewActivity.class).putExtra("token",hexData));
            }else{
                startActivity(new Intent(ConnectDemoActivity.this,SuccessFailureActivity.class).putExtra("status","success"));
            }
        }
        ...
        public void onSystemVolumeChanged(int oldVolume, int newVolume) {
             ...
             */
            Toast.makeText(ConnectDemoActivity.this, "System volume has been changed to:" + newVolume, Toast.LENGTH_SHORT).show();
